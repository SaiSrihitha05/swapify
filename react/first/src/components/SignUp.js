      ...
      <div className="row">
        <div className="col-md-6 d-flex align-items-center justify-content-center">
          <div className="card shadow p-4">
            <h1 className="display-6 text-black mb-4">Sign Up</h1>
            <form onSubmit={handleSubmit(onSignUpFormSubmit)} className="w-100">
              <div className="form-group">
                {err && <p className="text-danger fs-5">{err}</p>}
                {signupSuccess && <p className="text-success fs-5">Signup successful! Redirecting to Sign In...</p>}
              </div>
